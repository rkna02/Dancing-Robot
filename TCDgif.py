            ...
            while True:
                ...
                if keys:
                    ...
                    if keys == [1]:
                        ...
                        loading("/GIF/loading", "2")
                        move2 = True
                        move_set2()
                        resetto90()
                    elif keys == [3]:
                        sub_button1_active(3)
                        loading("/GIF/loading", "3")
                        move3 = True
                        move_set3()
                        resetto90()
                    elif keys == [4]:
                        sub_button1_active(4)
                        loading("/GIF/loading", "4")
                        move4 = True
                        move_set4()
                        resetto90()
                    elif keys == [5]:
                        sub_button1_active(5)
                        loading("/GIF/loading", "5")
                        move5 = True
                        move_set5()
                        resetto90()
                    elif keys == [6]:
                        sub_button1_active(6)
                        loading("/GIF/loading", "6")
                        move6 = True
                        move_set6()
                        resetto90()
                    elif keys == [9]:
